...
public class OpenAPISerializer {
    public static OpenRecipe rowToOpenRecipe(Row row) {
        return OpenRecipe.builder()
                ...
                .infoCar(Double.parseDouble(row.getInfoCar())).infoEng(Double.parseDouble(row.getInfoEng()))
                .infoFat(Double.parseDouble(row.getInfoFat())).infoNa(Double.parseDouble(row.getInfoNa()))
                .infoPro(Double.parseDouble(row.getInfoPro())).infoWgt(Double.parseDouble(row.getInfoWgt()))
